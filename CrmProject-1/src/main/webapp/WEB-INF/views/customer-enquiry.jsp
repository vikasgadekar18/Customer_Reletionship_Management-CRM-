                ...
                <div class="card shadow p-4">
                    ...
                    <form:form action="customerenquiryform" method="post" modelAttribute="modelCustEnquiryAttr">
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="name" type="email" cssClass="form-control" />
                            <form:errors path="name" cssClass="text-danger small" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Intersted Course</label>
                            <form:select path="interstedcourse" cssClass="form-select" >
                              <form:option value="">Selected Course</form:option>
                              <form:options items="${model_coursename_list}"/>

                             </form:select>
                            <form:errors path="interstedcourse" cssClass="text-danger small" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Discussion</label>
                            <form:textarea path="discussion" cssClass="form-control" />
                            <form:errors path="discussion" cssClass="text-danger small" />
                        </div>
                          <div class="mb-3">
                            <label class="form-label">Enquiry Type </label>
                             <form:select path="enquirytype" cssClass="form-select" >
                              <form:option value=""> Select Enqiury Type</form:option>
                            ...
                            <form:errors path="enquirytype" cssClass="text-danger small" />
                        </div>
                        <div class="mb-3">
                             ...
                             <form:select path="status" cssClass="form-select" >
                              <form:option value=""> Select Status</form:option>
                                <form:option value=" 1">Open(1)</form:option>
                                  <form:option value="2">Intersted-close(2)</form:option>
                                    <form:option value="3">Not Intersted-close(3)</form:option>
                        ...
                        <div class="mb-3">
                            ...
                            <form:errors path="followupdate" cssClass="text-danger small" />
                        </div>
                        <div class="mb-3">
                           ...
                           <form:select path="callto" cssClass="form-select" >
                            ...
                            <form:errors path="callto" cssClass="text-danger small" />
                        </div>
